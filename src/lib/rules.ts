...
const SOURCE_REVIEW_ACTIONABLE = /^(Add related passes as a group|Tell the system when your passes expire|Supply a high-resolution logo image|Supply distinct, high-resolution product images|Supply a prioritized list of your apps|In general, keep text brief|semantic tags are required)\b/i;
