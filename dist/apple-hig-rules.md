...
- **HIG-FOUNDATIONS-ACCESSIBILITY-0001 · SHOULD · low** — Ensure the experience accommodates larger text sizes. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0002 · SHOULD · low** — Choose or apply recommended defaults for custom type sizes in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0003 · SHOULD · low** — Apply the documented Accessibility guidance to strive to meet color contrast minimum standards. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0004 · SHOULD · low** — Favor system-defined colors when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0005 · SHOULD · low** — Apply the documented Accessibility guidance to convey information with more than color alone. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0006 · SHOULD · low** — Apply the documented Accessibility guidance to describe your app’s interface and content for VoiceOver. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0007 · SHOULD · low** — Ensure the experience accommodates text-based ways to enjoy audio and video. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0008 · SHOULD · low** — Choose or apply haptics in addition to audio cues in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0009 · SHOULD · low** — Apply the documented Accessibility guidance to augment audio cues with visual cues. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0010 · SHOULD · low** — Make sufficiently sized controls available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0011 · MAY · low** — Evaluate whether spacing between controls as important as size is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0012 · SHOULD · low** — Ensure the experience accommodates simple gestures for common interactions. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0013 · SHOULD · low** — Make alternatives to gestures available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0014 · SHOULD · low** — Preserve people’s ability to use Voice Control to give guidance and enter information verbally. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0015 · SHOULD · low** — Ensure the experience accommodates mobility-related assistive technologies. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0016 · SHOULD · low** — Preserve people’s ability to use the keyboard alone to navigate and interact with your app. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0017 · SHOULD · low** — Ensure the experience accommodates switch Control. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0018 · SHOULD · low** — Maintain actions simple and intuitive. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0019 · SHOULD · low** — Apply the documented Accessibility guidance to minimize use of time-boxed interface elements. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0020 · MAY · low** — Evaluate whether offering difficulty accommodations in games is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0021 · SHOULD · low** — Preserve people’s ability to control audio and video playback. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0022 · SHOULD · low** — Apply the documented Accessibility guidance to allow people to opt out of flashing lights in video playback. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0023 · SHOULD · low** — Apply the documented Accessibility guidance to be cautious with fast-moving and blinking animations. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0024 · SHOULD · low** — Apply the documented Accessibility guidance to optimize your app’s UI for Assistive Access. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
- **HIG-FOUNDATIONS-ACCESSIBILITY-0025 · SHOULD · low** — Apply the documented Accessibility guidance to prioritize comfort. ([source](https://developer.apple.com/design/human-interface-guidelines/accessibility))
### app-icons
...
- **HIG-FOUNDATIONS-COLOR-0017 · MAY · low** — Evaluate whether choosing a limited color palette that coordinates with your app logo is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/color))
- **HIG-FOUNDATIONS-COLOR-0018 · AVOID · low** — Exclude using only color to indicate focus from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/color))
- **HIG-FOUNDATIONS-COLOR-0019 · SHOULD · low** — Choose or apply color sparingly, especially on glass in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/color))
- **HIG-FOUNDATIONS-COLOR-0020 · SHOULD · low** — Favor using color in bold text and large areas when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/color))
- **HIG-FOUNDATIONS-COLOR-0021 · SHOULD · low** — Choose or apply background color to support existing content or supply additional information in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/color))
### dark-mode
...
- **HIG-FOUNDATIONS-ICONS-0008 · SHOULD · low** — Apply the documented Icons guidance to design simple images that clearly communicate the document type. ([source](https://developer.apple.com/design/human-interface-guidelines/icons))
...
- **HIG-FOUNDATIONS-INCLUSION-0001 · MAY · low** — Evaluate whether the tone of your copy from different perspectives is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/inclusion))
- **HIG-FOUNDATIONS-INCLUSION-0002 · AVOID · low** — Exclude using specialized or technical terms without defining them from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/inclusion))
- **HIG-FOUNDATIONS-INCLUSION-0003 · MAY · low** — Evaluate whether carefully before including humor is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/inclusion))
- **HIG-FOUNDATIONS-INCLUSION-0004 · AVOID · low** — Exclude images and language that exclude people with disabilities from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/inclusion))
- **HIG-FOUNDATIONS-INCLUSION-0005 · SHOULD · low** — Apply the documented Inclusion guidance to prioritize simplicity and perceivability. ([source](https://developer.apple.com/design/human-interface-guidelines/inclusion))
### layout
...
- **HIG-FOUNDATIONS-PRIVACY-0001 · SHOULD · low** — Apply the documented Privacy guidance to be transparent about how your app collects and uses people’s data. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0002 · SHOULD · low** — Apply the documented Privacy guidance to adopt system-defined privacy protections and follow security best practices. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0003 · AVOID · low** — Exclude requesting permission at launch unless the data or resource is required for your app to function from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0004 · SHOULD · low** — Apply the documented Privacy guidance to write copy that clearly describes how your app uses the ability, data, or resource you’re requesting. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0005 · SHOULD · low** — Apply the documented Privacy guidance to include only one button and make it clear that it opens the system alert. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0006 · AVOID · low** — Exclude include additional actions in your custom screen or window from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
...
- **HIG-FOUNDATIONS-PRIVACY-0008 · MAY · low** — Evaluate whether using the location button to give people a lightweight way to share their location for specific app features is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0009 · MAY · low** — Evaluate whether customizing the location button to harmonize with your UI is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0010 · AVOID · low** — Exclude relying solely on passwords for authentication from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
...
- **HIG-FOUNDATIONS-PRIVACY-0012 · AVOID · low** — Exclude inventing custom authentication schemes from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
- **HIG-FOUNDATIONS-PRIVACY-0013 · AVOID · low** — Exclude making assumptions about who is signed in from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/privacy))
### right-to-left
...
- **HIG-PATTERNS-PLAYING-VIDEO-0001 · SHOULD · low** — Choose or apply the system video player to give people a familiar and convenient experience in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0002 · MUST · medium** — Display video content at its original aspect ratio in every applicable case. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0003 · SHOULD · low** — Make additional information when it adds value available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0004 · SHOULD · low** — Ensure the experience accommodates the interactions people expect, regardless of the input device they’re using to control playback. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0005 · AVOID · low** — Exclude allowing audio from different sources to mix as viewers switch between modes from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0006 · MUST · medium** — Verify that a smooth transition to your app. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0007 · SHOULD · low** — Present the expected content immediately in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0008 · AVOID · low** — Exclude asking people if they want to resume playback from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0009 · MUST · medium** — Verify that content plays for the correct viewer. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0010 · SHOULD · low** — Choose or apply the previous end time when resuming playback of a long video clip in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0011 · AVOID · low** — Exclude displaying loading screens when possible from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0012 · SHOULD · low** — Apply the documented Playing video guidance to minimize loading screen content. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0013 · SHOULD · low** — Present a contextually relevant screen in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0014 · SHOULD · low** — Apply the documented Playing video guidance to be prepared for an immediate exit. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0015 · SHOULD · low** — Apply the documented Playing video guidance to defer to content when displaying logos or noninteractive overlays above video. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0016 · SHOULD · low** — Present interactive overlays gracefully in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0017 · SHOULD · low** — Apply the documented Playing video guidance to help people stay comfortable when playing video in your app. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0018 · AVOID · low** — Exclude automatically starting a fully immersive video playback experience from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0019 · SHOULD · low** — Apply the documented Playing video guidance to create a thumbnail track if you want to support scrubbing. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0020 · AVOID · low** — Exclude expanding an inline video player to fill a window from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0021 · SHOULD · low** — Choose or apply a RealityKit video player if you need to play video in a view like a splash screen or in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
- **HIG-PATTERNS-PLAYING-VIDEO-0022 · SHOULD · low** — Maintain video clips short. ([source](https://developer.apple.com/design/human-interface-guidelines/playing-video))
...
- **HIG-COMPONENTS-ACTION-SHEETS-0006 · SHOULD · low** — Choose or apply an action sheet — not a menu — to provide choices related to an action in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/action-sheets))
- **HIG-COMPONENTS-ACTION-SHEETS-0007 · AVOID · low** — Exclude letting an action sheet scroll from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/action-sheets))
- **HIG-COMPONENTS-ACTION-SHEETS-0008 · AVOID · low** — Exclude displaying more than four buttons in an action sheet, including the Cancel button from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/action-sheets))
### activity-rings
...
- **HIG-COMPONENTS-ALERTS-0001 · SHOULD · low** — Choose or apply alerts sparingly in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0002 · AVOID · low** — Exclude using an alert merely to provide information from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0003 · AVOID · low** — Exclude displaying alerts for common, undoable actions, even when they’re destructive from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0004 · AVOID · low** — Exclude showing an alert when your app starts from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0005 · SHOULD · low** — Apply the documented Alerts guidance to write a title that clearly and succinctly describes the situation. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0006 · SHOULD · low** — Apply the documented Alerts guidance to include informative text only if it adds value. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0007 · AVOID · low** — Exclude explaining alert buttons from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0008 · SHOULD · low** — Apply the documented Alerts guidance to create succinct, logical button titles. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0009 · AVOID · low** — Exclude using OK as the default button title unless the alert is purely informational from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0010 · SHOULD · low** — Apply the documented Alerts guidance to place buttons where people expect. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0011 · SHOULD · low** — Choose or apply the destructive style to identify a button that performs a destructive action people didn’t deliberately choose in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0012 · SHOULD · low** — Make alternative ways to cancel an alert when it makes sense available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0013 · SHOULD · low** — Choose or apply an action sheet — not an alert — to offer choices related to an intentional action in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
- **HIG-COMPONENTS-ALERTS-0014 · SHOULD · low** — Choose or apply a caution symbol sparingly in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/alerts))
### app-shortcuts
...
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0001 · SHOULD · low** — Make live Activities for tasks and events that have a defined beginning and end available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0002 · AVOID · low** — Exclude use a Live Activity to display ads or promotions from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0003 · AVOID · low** — Exclude displaying sensitive information from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0004 · SHOULD · low** — Apply the documented Live Activities guidance to create a Live Activity that matches your app’s visual aesthetic and personality in both dark and light appearances. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0005 · AVOID · low** — Exclude add elements to your app that draw attention to the Dynamic Island from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
...
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0007 · SHOULD · low** — Choose or apply familiar layouts for custom views and layouts in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0008 · SHOULD · low** — Choose or apply consistent margins and concentric placement in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0009 · SHOULD · low** — Choose or apply color to express the character and identity of your app in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0010 · SHOULD · low** — Choose or apply animations to reinforce the information you’re communicating and to bring attention to updates in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
...
- **HIG-COMPONENTS-LIVE-ACTIVITIES-0026 · SHOULD · low** — Choose or apply standard margins and avoid extending graphic elements to the edge of the screen in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/live-activities))
...
- **HIG-COMPONENTS-NOTIFICATIONS-0019 · AVOID · low** — Exclude using a short look as the only way to communicate important information from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0020 · SHOULD · low** — Maintain privacy in mind. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0021 · MAY · low** — Evaluate whether using a rich, custom long-look notification to let people get the information they need without launching your app is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0022 · SHOULD · low** — Apply the documented Notifications guidance to choose a background appearance for the sash. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0023 · SHOULD · low** — Apply the documented Notifications guidance to choose a background color for the content area. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0024 · SHOULD · low** — Make up to four custom actions below the content area available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
- **HIG-COMPONENTS-NOTIFICATIONS-0025 · SHOULD · low** — Maintain double tap in mind when choosing the order of custom actions you present as responses to a notification. ([source](https://developer.apple.com/design/human-interface-guidelines/notifications))
### ornaments
...
- **HIG-COMPONENTS-PAGE-CONTROLS-0005 · AVOID · low** — Exclude animating page transitions during scrubbing from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/page-controls))
- **HIG-COMPONENTS-PAGE-CONTROLS-0006 · AVOID · low** — Exclude supporting the scrubber when you use the minimal background style from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/page-controls))
- **HIG-COMPONENTS-PAGE-CONTROLS-0007 · SHOULD · low** — Choose or apply page controls on collections of full-screen pages in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/page-controls))
- **HIG-COMPONENTS-PAGE-CONTROLS-0008 · SHOULD · low** — Choose or apply vertical pagination to separate multiple views into distinct, purposeful pages in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/page-controls))
- **HIG-COMPONENTS-PAGE-CONTROLS-0009 · MAY · low** — Evaluate whether limiting the content of an individual page to a single screen height is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/page-controls))
### panels

- **HIG-COMPONENTS-PANELS-0001 · SHOULD · low** — Choose or apply a panel to give people quick access to important controls or information related to the content they’re working in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0002 · MAY · low** — Evaluate whether using a panel to present inspector functionality is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0003 · SHOULD · low** — Favor simple adjustment controls in a panel when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0004 · SHOULD · low** — Apply the documented Panels guidance to write a brief title that describes the panel’s purpose. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0005 · SHOULD · low** — Present and hide panels appropriately in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0006 · AVOID · low** — Exclude including panels in the Window menu’s documents list from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0007 · SHOULD · low** — Favor standard panels when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0008 · SHOULD · low** — Apply the documented Panels guidance to maintain one panel style when your app switches modes. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0009 · SHOULD · low** — Choose or apply color sparingly in HUDs in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
- **HIG-COMPONENTS-PANELS-0010 · SHOULD · low** — Maintain hUDs small. ([source](https://developer.apple.com/design/human-interface-guidelines/panels))
### path-controls
...
- **HIG-COMPONENTS-POPOVERS-0012 · AVOID · low** — Exclude displaying popovers in compact views from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/popovers))
- **HIG-COMPONENTS-POPOVERS-0013 · MAY · low** — Evaluate whether letting people detach a popover is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/popovers))
- **HIG-COMPONENTS-POPOVERS-0014 · SHOULD · low** — Apply the documented Popovers guidance to make minimal appearance changes to a detached popover. ([source](https://developer.apple.com/design/human-interface-guidelines/popovers))
### progress-indicators
...
- **HIG-COMPONENTS-PROGRESS-INDICATORS-0006 · SHOULD · low** — Favor an activity indicator (spinner) to communicate the status of a background operation or when space is constrained when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/progress-indicators))
- **HIG-COMPONENTS-PROGRESS-INDICATORS-0007 · AVOID · low** — Exclude labeling a spinning progress indicator from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/progress-indicators))
### pull-down-buttons
...
- **HIG-COMPONENTS-SCROLL-VIEWS-0007 · MAY · low** — Evaluate whether showing a page control when a scroll view is in page-by-page mode is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
- **HIG-COMPONENTS-SCROLL-VIEWS-0008 · SHOULD · low** — Ensure the experience accommodates look to Scroll for reading or browsing views. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
- **HIG-COMPONENTS-SCROLL-VIEWS-0009 · AVOID · low** — Exclude using Look to Scroll for secondary content from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
- **HIG-COMPONENTS-SCROLL-VIEWS-0010 · SHOULD · low** — Apply the documented Scroll views guidance to maintain consistency across content. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
- **HIG-COMPONENTS-SCROLL-VIEWS-0011 · SHOULD · low** — Favor vertically scrolling content when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
- **HIG-COMPONENTS-SCROLL-VIEWS-0012 · SHOULD · low** — Choose or apply tab views to provide page-by-page scrolling in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/scroll-views))
### search-fields
...
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0006 · MAY · low** — Evaluate whether a segmented control to switch between closely related subviews is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0007 · MAY · low** — Evaluate whether using introductory text to clarify the purpose of a segmented control is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0008 · SHOULD · low** — Choose or apply a tab view in the main window area — instead of a segmented control — for view switching in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0009 · MAY · low** — Evaluate whether supporting spring loading is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0010 · MAY · low** — Evaluate whether using a split view instead of a segmented control on screens that perform content filtering is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
- **HIG-COMPONENTS-SEGMENTED-CONTROLS-0011 · AVOID · low** — Exclude putting other focusable elements close to segmented controls from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/segmented-controls))
### sheets
...
- **HIG-COMPONENTS-SHEETS-0004 · SHOULD · low** — Apply the documented Sheets guidance to include a grabber in a resizable sheet. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0005 · SHOULD · low** — Ensure the experience accommodates swiping to dismiss a sheet. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0006 · SHOULD · low** — Favor using the page or form sheet presentation styles in an iPadOS app when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0007 · SHOULD · low** — Preserve people’s ability to interact with other app windows without first dismissing a sheet. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0008 · SHOULD · low** — Choose or apply a panel instead of a sheet if people need to repeatedly provide input and observe results in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0009 · AVOID · low** — Exclude displaying a sheet that emerges from the bottom edge of a window from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0010 · SHOULD · low** — Choose or apply a sheet only when your modal task requires a custom title or custom content presentation in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
- **HIG-COMPONENTS-SHEETS-0011 · SHOULD · low** — Maintain sheet interactions brief and occasional. ([source](https://developer.apple.com/design/human-interface-guidelines/sheets))
### sidebars
...
- **HIG-COMPONENTS-SIDEBARS-0004 · MAY · low** — Evaluate whether using a tab bar first is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/sidebars))
- **HIG-COMPONENTS-SIDEBARS-0005 · MAY · low** — Evaluate whether automatically hiding and revealing a sidebar when its container window resizes is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/sidebars))
- **HIG-COMPONENTS-SIDEBARS-0006 · AVOID · low** — Exclude putting critical information or actions at the bottom of a sidebar from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/sidebars))
### sliders
...
- **HIG-COMPONENTS-SLIDERS-0003 · AVOID · low** — Exclude use a slider to adjust audio volume from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0004 · MAY · low** — Evaluate whether giving live feedback as the value of a slider changes is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0005 · SHOULD · low** — Apply the documented Sliders guidance to choose a slider style that matches peoples’ expectations. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0006 · MAY · low** — Evaluate whether using a label to introduce a slider is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0007 · SHOULD · low** — Choose or apply tick marks to increase clarity and accuracy in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0008 · MAY · low** — Evaluate whether adding labels to tick marks for even greater clarity is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
- **HIG-COMPONENTS-SLIDERS-0009 · SHOULD · low** — Favor horizontal sliders when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/sliders))
### snippets
...
- **HIG-COMPONENTS-STATUS-BARS-0001 · MAY · low** — Evaluate whether temporarily hiding the status bar when displaying full-screen media is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/status-bars))
- **HIG-COMPONENTS-STATUS-BARS-0002 · AVOID · low** — Exclude permanently hiding the status bar from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/status-bars))
### steppers
...
- **HIG-COMPONENTS-TAB-VIEWS-0001 · SHOULD · low** — Choose or apply a tab view to present closely related areas of content in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/tab-views))
...
- **HIG-COMPONENTS-TAB-VIEWS-0003 · SHOULD · low** — Make a label for each tab that describes the contents of its pane available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/tab-views))
- **HIG-COMPONENTS-TAB-VIEWS-0004 · AVOID · low** — Exclude using a pop-up button to switch between tabs from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/tab-views))
- **HIG-COMPONENTS-TAB-VIEWS-0005 · AVOID · low** — Exclude providing more than six tabs in a tab view from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/tab-views))
### text-fields
...
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0001 · SHOULD · low** — Ensure the experience accommodates behaviors people intuitively expect when using a marking instrument. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0002 · SHOULD · low** — Preserve people’s ability to choose when to switch between Apple Pencil and finger input. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0003 · SHOULD · low** — Preserve people’s ability to make a mark the moment Apple Pencil touches the screen. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0004 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to help people express themselves by responding to the way they use Apple Pencil. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0005 · SHOULD · low** — Make visual feedback to indicate a direct connection with content available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0006 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to design a great left- and right-handed experience. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0007 · SHOULD · low** — Choose or apply hover to help people predict what will happen when Apple Pencil touches the screen in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0008 · AVOID · low** — Exclude using hover to initiate an action from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0009 · SHOULD · low** — Favor showing a preview value that’s near the middle in a range of dynamic values when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0010 · MAY · low** — Evaluate whether using hover to support relevant interactions close to where people are marking is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0011 · SHOULD · low** — Favor showing hover previews for Apple Pencil, not for a pointing device when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0012 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to respect people’s settings for the double-tap gesture when they make sense in your app. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0013 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to give people a way to specify custom double-tap behavior if necessary. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0014 · AVOID · low** — Exclude using the double-tap gesture to perform an action that modifies content from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0015 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to treat squeeze as a single, quick gesture that performs a discrete — not continuous — action. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0016 · SHOULD · low** — Choose or apply barrel roll only to modify marking behavior, not to enable navigation or display other controls in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0017 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to make text entry feel fluid and effortless. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0018 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to make Scribble available everywhere people might want to enter text. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0019 · AVOID · low** — Exclude distracting people while they write from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0020 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to give people enough space to write. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0021 · SHOULD · low** — Apply the documented Apple Pencil and Scribble guidance to help people draw on top of existing content. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
- **HIG-INPUTS-APPLE-PENCIL-AND-SCRIBBLE-0022 · MAY · low** — Evaluate whether displaying custom undo and redo buttons when your app runs in a compact environment is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/apple-pencil-and-scribble))
### camera-control
...
- **HIG-INPUTS-POINTING-DEVICES-0001 · SHOULD · low** — Apply the documented Pointing devices guidance to be consistent when responding to mouse and trackpad gestures. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0002 · AVOID · low** — Exclude redefining systemwide trackpad gestures from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0003 · SHOULD · low** — Make a consistent experience in your app, whether people are using gestures, eyes, a pointing device, or a keyboard available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0004 · SHOULD · low** — Preserve people’s ability to use the pointer to reveal and hide controls that automatically minimize or fade out. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0005 · SHOULD · low** — Make a consistent experience when people press and hold a modifier key while interacting with objects in your app available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0006 · SHOULD · low** — Apply the documented Pointing devices guidance to allow multiple selection in custom views when necessary. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0007 · SHOULD · low** — Apply the documented Pointing devices guidance to distinguish between pointer and finger input only if it provides value. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0008 · SHOULD · low** — Choose or apply clear, simple images to create custom accessories in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0009 · MAY · low** — Evaluate whether using the accessory transition to signal a change in an element’s state or behavior is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0010 · SHOULD · low** — Favor the system-provided pointer appearances for standard buttons and text-entry areas when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0011 · SHOULD · low** — Apply the documented Pointing devices guidance to create contiguous hit regions for custom bar buttons. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0012 · SHOULD · low** — Favor system-provided pointer effects for custom elements that behave like standard elements when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0013 · SHOULD · low** — Choose or apply pointer effects in consistent ways throughout your app in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0014 · AVOID · low** — Exclude creating gratuitous pointer and content effects from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0015 · SHOULD · low** — Maintain custom pointer shapes simple. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0016 · MAY · low** — Evaluate whether enhancing the pointer experience by displaying custom annotations that provide useful information is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0017 · AVOID · low** — Exclude displaying instructional text with a pointer from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
- **HIG-INPUTS-POINTING-DEVICES-0018 · MAY · low** — Evaluate whether the interplay of shadow, scale, and element spacing when defining custom hover effects is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/pointing-devices))
### remotes
...
- **HIG-TECHNOLOGIES-APP-CLIPS-0002 · AVOID · low** — Exclude use App Clips solely for marketing purposes from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0003 · AVOID · low** — Exclude using web views in your App Clip from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0004 · SHOULD · low** — Apply the documented App Clips guidance to design a linear, easy-to-use, and focused user interface. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0005 · MUST · medium** — Verify that people can use your App Clip immediately. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0006 · MUST · medium** — Verify that your App Clip is small. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0007 · SHOULD · low** — Apply the documented App Clips guidance to make the App Clip shareable. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0008 · SHOULD · low** — Apply the documented App Clips guidance to make it easy to pay for a service or product. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0009 · AVOID · low** — Exclude requiring people to create an account before they can benefit from your App Clip from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0010 · SHOULD · low** — Make a familiar, focused experience in your app available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0011 · MAY · low** — Evaluate whether offering Sign in with Apple is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0012 · SHOULD · low** — Make a secure way to pay for services or goods that also respects people’s privacy available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0013 · AVOID · low** — Exclude compromise the user experience by asking people to install the full app from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0014 · SHOULD · low** — Maintain notifications focused. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0015 · SHOULD · low** — Choose or apply notifications to help people complete a task in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0016 · SHOULD · low** — Choose or apply consistent branding in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0017 · MAY · low** — Evaluate whether multiple businesses is appropriate for the current context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0018 · SHOULD · low** — Apply the documented App Clips guidance to be informative. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0019 · SHOULD · low** — Favor photography and graphics when the documented conditions apply. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0020 · AVOID · low** — Exclude using text from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0021 · SHOULD · low** — Choose or apply concise copy in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0022 · SHOULD · low** — Apply the documented App Clips guidance to include the App Clip logo when space allows. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0023 · SHOULD · low** — Apply the documented App Clips guidance to place your App Clip Code on a flat or cylindrical surface only. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0024 · SHOULD · low** — Apply the documented App Clips guidance to help your App Clip Code remain as flat as possible so it’s easy for people to scan. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0025 · SHOULD · low** — Apply the documented App Clips guidance to place your App Clip Code in a location that helps ensure reliable scanning. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0026 · MUST · medium** — Verify that the App Clip Code is unobstructed. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0027 · SHOULD · low** — Present the App Clip Code in an upright position in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0028 · AVOID · low** — Exclude create App Clip Codes that are too small from the applicable experience. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0029 · SHOULD · low** — Make enough space between an App Clip Code and adjacent App Clip Codes, graphics, or materials available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0030 · MUST · medium** — Use the generated App Clip Code in every applicable case. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0031 · SHOULD · low** — Apply the documented App Clips guidance to choose colors with enough contrast that ensure accurate scanning. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0032 · SHOULD · low** — Choose or apply high-quality, non-textured print materials in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
- **HIG-TECHNOLOGIES-APP-CLIPS-0033 · SHOULD · low** — Choose or apply high-resolution images and printer settings in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/app-clips))
...
- **HIG-TECHNOLOGIES-TAP-TO-PAY-ON-IPHONE-0001 · SHOULD · low** — Apply the documented Tap to Pay on iPhone guidance to help merchants accept Tap to Pay on iPhone terms and conditions before they begin interacting with their customers. ([source](https://developer.apple.com/design/human-interface-guidelines/tap-to-pay-on-iphone))
...
- **HIG-TECHNOLOGIES-TAP-TO-PAY-ON-IPHONE-0009 · SHOULD · low** — Apply the documented Tap to Pay on iPhone guidance to help merchants complete the checkout flow when a payment can’t complete with Tap to Pay on iPhone. ([source](https://developer.apple.com/design/human-interface-guidelines/tap-to-pay-on-iphone))
- **HIG-TECHNOLOGIES-TAP-TO-PAY-ON-IPHONE-0010 · SHOULD · low** — Apply the documented Tap to Pay on iPhone guidance to make it easy for merchants to get help with issues they can’t resolve. ([source](https://developer.apple.com/design/human-interface-guidelines/tap-to-pay-on-iphone))
- **HIG-TECHNOLOGIES-TAP-TO-PAY-ON-IPHONE-0011 · SHOULD · low** — Choose or apply a generic label in a button that opens the Tap to Pay on iPhone screen to read a in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/tap-to-pay-on-iphone))
### voiceover

- **HIG-TECHNOLOGIES-VOICEOVER-0001 · SHOULD · low** — Make alternative labels for all key interface elements available when applicable. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
- **HIG-TECHNOLOGIES-VOICEOVER-0002 · SHOULD · low** — Apply the documented VoiceOver guidance to describe meaningful images. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
- **HIG-TECHNOLOGIES-VOICEOVER-0003 · SHOULD · low** — Apply the documented VoiceOver guidance to make charts and other infographics fully accessible. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
- **HIG-TECHNOLOGIES-VOICEOVER-0004 · SHOULD · low** — Choose or apply titles and headings to help people navigate your information hierarchy in the documented context. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
- **HIG-TECHNOLOGIES-VOICEOVER-0005 · SHOULD · low** — Ensure the experience accommodates the VoiceOver rotor when possible. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
- **HIG-TECHNOLOGIES-VOICEOVER-0006 · SHOULD · low** — Apply the documented VoiceOver guidance to be mindful that custom gestures aren’t always accessible. ([source](https://developer.apple.com/design/human-interface-guidelines/voiceover))
### wallet
